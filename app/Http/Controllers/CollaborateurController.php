...
class CollaborateurController extends Controller
{
            ...
            ->when(Request::input('search'), function ($query, $search) {
                ...
                ->through(fn($collaborateur) => [
                    ...
                    'organisation' => [
                        ...
                        'sigle' => $collaborateur->organisation->sigle ?? "Ø",
                    ],
                ]),
    ...
    public function store()
    {
        ...
        return Redirect::route('collaborateur')->with('success', 'Collaborateur créé.');
    }
    ...
    {
        return Inertia::render('Collaborateur/Corbeille', [
            'collaborateurs' => Collaborateur::query()
            ->when(Request::input('search'), function ($query, $search) {
                    $query->where('n_client', 'like', "%{$search}%")
                        ->orWhere('nom', 'like', "%{$search}%")
