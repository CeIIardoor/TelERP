  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex justify-between">
        ...
        <Link v-if="$attrs.auth.user.role == 'Administrateur'" :href="route('corbeille.abonnement')"
      ...
      <div class="overflow-x-auto relative max-w-full shadow-lg sm:rounded-lg">
        <div class="flex justify-between items-center p-4 bg-white dark:bg-gray-800">
          <div class="flex gap-2">
            <Link href="/abonnement/create" class="text-green-500 hover:text-green-700 text-sm ml-3">
          ...
          <div class="relative">
            ...
            <input v-model="search" type="text" id="table-search-users"
              class="block p-2 pl-10 w-5/6 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr v-for="abonnement in $page.props.abonnements.data" :key="abonnement.id"
              ...
              <td class="flex pt-6 space-x-0.5 h-6 w-6">
                <Link :href="`/abonnement/${abonnement.id}/factures`">
                <button type="button"
                  class="px-2 py-3 focus:outline-none text-white bg-gradient-to-br from-green-400 to-green-600 hover:bg-gradient-to-bl focus:ring-4 focus:ring-emerald-300 font-medium rounded-full text-xs">
                  Factures
                </button>
                </Link>
                <!-- Modal toggle -->
                <a href="#" type="button" @click="openModal(abonnement)" data-modal-toggle="editUserModal">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mt-2 text-blue-600 hover:text-blue-900" fill="none" viewBox="0 0 24 24"
                ...
                <!-- Delete record -->
                <Link :href="`/abonnement/${abonnement.id}/delete`" class="text-red-600 hover:text-red-900">
        ...
        <!-- Edit user modal -->
        <div v-if="!closed" id="editUserModal" tabindex="-1"
          ...
          <div class="relative w-full max-w-2xl h-full md:h-auto">
            ...
            <form id="abonnement_form" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="grid grid-cols-9 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input id="prenom" type="text" name="prenom"
                      ...
                      placeholder="Prénom" required="" :value="modal_data.prenom" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="nom" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom</label>
                    <input type="text" name="nom" id="nom"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="Nom" required="" :value="modal_data.nom" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="n_client" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">N°
                      client</label>
                    <input type="text" name="n_client" id="n_client"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="N_client" required="" :value="modal_data.n_client" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="CIN" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CIN</label>
                    <input type="text" name="CIN" id="CIN"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="CIN" required="" :value="modal_data.CIN" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="ville" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ville</label>
                    <input type="text" name="ville" id="Ville"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="ville" :value="modal_data.ville" />
                  </div>

                  <div class="col-span-6 sm:col-span-3">
                    <label for="derniere_affectation"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Derniere affectation</label>
                    <input type="text" name="derniere_affectation" id="derniere_affectation"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="Derniere Affectaion" :value="modal_data.derniere_affectation" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="dernier_grade"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dernier Grade</label>
                    <input type="text" name="dernier_grade" id="dernier_grade"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="Dernier Grade" :value="modal_data.dernier_grade" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="gestionnaire"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gestionnaire</label>
                    <input type="text" name="gestionnaire" id="gestionnaire"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="Gestionnaire" :value="modal_data.gestionnaire" />
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                    <label for="derniere_province"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Derniere_province</label>
                    <input type="text" name="derniere_province" id="derniere_province"
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
                      placeholder="Dernière province" :value="modal_data.derniere_province" />
                  </div>
                  <div class="col-span-6 sm:col-span-9">
                    ...
                    <select name="organisation_id" id="organisation_id"
                      ...
                      <option v-for="org in orgs" :key="org.id" :selected="org.id === modal_data.organisation.id"
                        :value="org.id">
                        {{ org.intitule }}
                      </option>
                    </select>
              ...
              <div
                ...
                <button type="submit" @click.prevent="update_abonnement(modal_data.id)"
    ...
    <div v-hide-toast v-if="$attrs.flash.success && toasted" id="toast-bottom-right"
    ...
    <div v-hide-toast v-if="$attrs.flash.error && toasted" id="toast-bottom-right"
      class="flex justify-evenly fixed right-5 bottom-5 items-center p-4 space-x-4 w-full max-w-xs text-gray-500 bg-white rounded-lg divide-x divide-gray-200 shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800"
      role="alert">
      <div
